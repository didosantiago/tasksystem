...
Storage = {
	-- Join Task Grizzly Adam storages
	JOIN_STOR = 100157,
	-- Roullet storages
	roulettefinishes = 300000,
	-- Backpack Capacity storages
	BACKPACK_CAPACITY_STOR = 300100,
	-- General storages
	Dragonfetish = 30003,
		...
		U8_5 = { -- update 8.5 - Reserved Storages 42146 - 42550
			...
			KillingInTheNameOf = {
				...
				BossKillCount = {
					...
					MerikhCount = 42383,
					FahimCount = 42384,
					GrandpatrollCount = 42385,
					BonelessskeletonCount = 42386,
					MinotaurberserkerCount = 42387,
				},
				AltKillCount = {
					-- Grizzly Adams
					-- Apes
