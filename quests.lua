		...
		[11] = {
			...
			missions = {
				...
				[7] = { -- Grizzly Adams
					...
					states = {
						[0] = function(player)
							return string.format("You already hunted %d/3 crocodiles.", player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.MonsterKillCount.CrocodileCount))
						end,
						[1] = "You successfully hunted 3 crocodiles. If you want to you may complete this task again.",
						[2] = "You succesfully hunted 3 crocodiles.",
					},
				},
				[8] = {
					name = "Paw and Fur: Trolls",
					storageId = 65002,
					missionId = 1088,
					startValue = 0,
					endValue = 2,
					states = {
						[0] = function(player)
							return string.format("You already hunted %d/3 trolls.", player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.MonsterKillCount.TrollCount))
						end,
						[1] = "You successfully hunted 3 trolls. If you want to you may complete this task again.",
						[2] = "You succesfully hunted 3 trolls.",
					},
				},
				[9] = {
					...
					states = {
						[0] = function(player)
							return string.format("You already hunted %d/3 tarantulas.", player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.MonsterKillCount.TarantulaCount))
						end,
						[1] = "You successfully hunted 3 tarantulas. If you want to you may complete this task again.",
						[2] = "You succesfully hunted 3 tarantulas.",
					},
				},
				[10] = {
					name = "Paw and Fur: Skeletons",
					storageId = 65004,
					missionId = 1090,
					startValue = 0,
					endValue = 2,
					states = {
						[0] = function(player)
							return string.format("You already hunted %d/5 skeletons.", player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.MonsterKillCount.SkeletonCount))
						end,
						[1] = "You successfully hunted 5 skeletons. If you want to you may complete this task again.",
						[2] = "You succesfully hunted 5 skeletons.",
					},
				},
				[11] = {
					...
					states = {
						[0] = function(player)
							return string.format("You already hunted %d/2 minotaurs.", player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.MonsterKillCount.MinotaurCount))
						end,
						[1] = "You successfully hunted 2 minotaurs. If you want to you may complete this task again.",
						[2] = "You succesfully hunted 2 minotaurs.",
					},
				},
				[12] = {
				...
				[51] = {
					name = "Paw and Fur: Boneless Skeleton",
					storageId = 34103,
					missionId = 10131,
					startValue = 1,
					endValue = 3,
					states = {
						[1] = "Grizzly told you about 'Boneless Skeleton', a skeleton that already killed many citizens. Try find its hideout and kill it.",
						[2] = "You have found the hideout of Boneless Skeleton. Talk to Grizzly again.",
						[3] = "You've killed Boneless Skeleton and reported back to Grizzly.",
					},
				},
				[52] = {
					name = "Paw and Fur: Minotaur Berserker",
					storageId = 34104,
					missionId = 10132,
					startValue = 1,
					endValue = 3,
					states = {
						[1] = "Grizzly told you about the Minotaur Berserker, a mammoth that already killed many citizens. Try find its hideout and kill it.",
						[2] = "You have found the hideout of Minotaur Berserker. Talk to Grizzly again.",
						[3] = "You've killed the Minotaur Berserker and reported back to Grizzly.",
					},
				},
				[53] = {
				...
				[84] = {
					...
					states = {
						[0] = function(player)
							return string.format("Daniel Steelsoul sent you to kill 100 trolls, preferably under of Kahralias city. You have killed %d trolls and %d troll champions so far.", player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.AltKillCount.TrollCount), player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.AltKillCount.TrollChampionCount))
						end,
				...
				[87] = {
					name = "Paw and Fur: Grandpa Troll",
					storageId = 34101,
					missionId = 10451,
					startValue = 1,
					endValue = 3,
					states = {
						[1] = "Grizzly told you about 'Grandpa Troll', a troll that already killed many citizens. Try find its hideout and kill it.",
						[2] = "You have found the hideout of Grandpa Troll. Talk to Grizzly again.",
						[3] = "You've killed Grandpa Troll and reported back to Grizzly.",
					},
				},
				[88] = {
					...
					states = {
						[0] = function(player)
							return string.format(
								...
								player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.AltKillCount.Cyclops2Count),
								player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.AltKillCount.Cyclops2DroneCount),
								player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.AltKillCount.Cyclops2SmithCount)
							)
						end,
