local bosses = {
	{
		...
		storage = 34100,
		teleportPosition = { x = 32333, y = 32078, z = 8 }, -- teleport inicial
		playerPosition = Position(32306, 32108, 8), -- Aonde o player vai cair
		bossPosition = Position(32307, 32116, 8), -- posicao do boss
		centerPosition = Position(32304, 32112, 8),
		rangeX = 5,
		rangeY = 5,
		flamePosition = Position(32303, 32118, 8),
	},
	{
		bossName = "grandpa troll",
		storage = 34101,
		teleportPosition = { x = 32331, y = 32078, z = 8 }, -- teleport inicial
		playerPosition = Position(32305, 32108, 8), -- Aonde o player vai cair
		bossPosition = Position(32305, 32116, 8), -- posicao do boss
		centerPosition = Position(32303, 32112, 8),
		rangeX = 5,
		rangeY = 5,
		flamePosition = Position(32302, 32118, 8),
	},
	{
		bossName = "hide",
		storage = 34102,
		teleportPosition = {x = 32247, y = 31893, z = 8},
		playerPosition = Position(32270, 31858, 8),
		bossPosition = Position(32267, 31870, 8),
		centerPosition = Position(32267, 31868, 8),
		rangeX = 13,
		rangeY = 13,
